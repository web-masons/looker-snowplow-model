# Contributing
Please read through the following documentation to get acquainted with the project.

## The Vision
This project is for combining our Snowplow Event Model with Looker. The base model
was provided to us by the folks at Looker, and we're going to extend it. The general
purpose for putting these models live is so that others can learn from them, and
should they choose, also implement a similar system.
...
Since we use this model in our production environments, ever new feature request
will be scrutinized to make sure we're not going to experience feature bloat.
Every new feature should fit the Vision for the project. If you've got an idea
for an alteration to the model and you feel it fits the vision, file an issue
...
1. [Fork](http://help.github.com/fork-a-repo/) the project, clone your fork,
   ...
   git clone https://github.com/<your-username>/looker-snowplow-model
   # Navigate to the newly cloned directory
   cd looker-snowplow-model
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/web-masons/looker-snowplow-model
   ```
